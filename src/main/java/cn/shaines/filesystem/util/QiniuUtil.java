...
public class QiniuUtil {
    ...
    private static final long expireInSeconds = 3600;//1小时，可以自定义链接过期时间
    private static final CommonUtil COMMON_UTIL = CommonUtil.get();
    ...
    public static byte[] findByKey(String key) throws IOException {
        String encodedFileName = COMMON_UTIL.encodeUrl(key, "UTF-8");
